...
public class SunshinePreferences {
    ...
    public static String getPreferredWeatherLocation(Context context) {
        ...
        String location = sharedPreferences.getString(context.getString(R.string.pref_location_key),getDefaultWeatherLocation());
        return location;
    }
    ...
    public static boolean isMetric(Context context) {
        ...
        return unit.equals(context.getString(R.string.pref_units_metric)) ? true : false;
    }
